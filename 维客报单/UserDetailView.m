...
- (void)buttonClicked:(UIButton *)sender {
    ...
    if (sender.tag == 203) {
        ...
        cityVC.returnCity = ^(NSString *cityName,NSInteger row){
            ...
            NSDictionary *params = @{@"comid":@(userModel.CompanyID),@"parent":weakSelf.cityID};
            [NicoNetworking nicoGetWithBaseURL:HomeUrl subURL:@"/Common.ashx?action=getdistricts" parameters:params success:^(id responseObject) {
                if ([(NSArray *)responseObject count]) {
                    ...
                    NSDictionary *params = @{
                                             ...
                                             @"parent":weakSelf.discID
                                             };
                    
                    [NicoNetworking nicoGetWithBaseURL:HomeUrl subURL:@"/Common.ashx?action=gettown" parameters:params success:^(id responseObject) {
                        if ([(NSArray *)responseObject count]) {
...
- (void)netWorkingRequest {
    ...
    NSDictionary *params = @{@"comid":@(userModel.CompanyID)};
    [NicoNetworking nicoGetWithBaseURL:HomeUrl subURL:@"Common.ashx?action=getinfofrom" parameters:params success:^(id responseObject) {
        for (NSDictionary *dic in responseObject) {
    ...
    [NicoNetworking nicoGetWithBaseURL:HomeUrl subURL:@"/Common.ashx?action=getcity" parameters:params success:^(id responseObject) {
        ...
        NSDictionary *params = @{@"comid":@(userModel.CompanyID),@"parent":self.cityID};
        ...
        [NicoNetworking nicoGetWithBaseURL:HomeUrl subURL:@"/Common.ashx?action=getdistricts" parameters:params success:^(id responseObject) {
            ...
            NSDictionary *params = @{@"comid":@(userModel.CompanyID),@"parent":self.discID};
            [NicoNetworking nicoGetWithBaseURL:HomeUrl subURL:@"Common.ashx?action=gettown" parameters:params success:^(id responseObject) {
